...
//import com.gbsaver.chatlocker.Activity.DashboardActivity;
//import com.gbsaver.chatlocker.Activity.PrivacyPolicy;
//import com.gbsaver.chatlocker.Activity.SplashActivity;
import com.gbsaver.chatlocker.AdsUtils.FirebaseADHandlers.AdUtils;
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnCompleteListener(new OnCompleteListener<Boolean>() {
            ...
            public void onComplete(@NonNull Task<Boolean> task) {
                if (task.isSuccessful()) {
                    Constants.configData = Global.getConfigData(mFirebaseRemoteConfig.getString("openvpn"));
                    Log.println(Log.ASSERT, TAG, new Gson().toJson(mFirebaseRemoteConfig.getString("openvpn")));
