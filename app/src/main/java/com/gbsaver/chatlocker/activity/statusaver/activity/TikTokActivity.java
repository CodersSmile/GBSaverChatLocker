...
import static com.gbsaver.chatlocker.activity.statusaver.Utils.RootDirectoryTikTok;
...
public class TikTokActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        createFileFolder();
        initViews();
        AdUtils.showNativeAd(TikTokActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads_big), true);

        TVTitle.setImageDrawable(getResources().getDrawable(R.drawable.tiktok_icon));
        tvAppName.setText(getResources().getString(R.string.tiktok_app_name));
        appName.setText(getResources().getString(R.string.tiktok_app_name));
    ...
    private void GetTikTokData() {
        try {
            createFileFolder();
            String host = etText.getText().toString();
