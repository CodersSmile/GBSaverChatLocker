...
import static com.gbsaver.chatlocker.activity.statusaver.Utils.RootDirectoryShareChat;
...
public class SharechatActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        TVTitle.setImageDrawable(getResources().getDrawable(R.drawable.ic_icon_share_chat));
        tvAppName.setText(getResources().getString(R.string.sharechat_app_name));
        appName.setText(getResources().getString(R.string.sharechat_app_name));
        AdUtils.showNativeAd(SharechatActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads_big), true);
