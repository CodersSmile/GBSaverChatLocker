...
import com.gbsaver.chatlocker.activity.ConfirmPinLockActivity;
import com.gbsaver.chatlocker.utils.Util;

import java.lang.reflect.Method;
import java.util.Objects;

public final class ConfirmPinButtonAdapter extends BaseAdapter implements Util {
    private final Context context;
    private final String[] list = {"1", "2", "3", "4", "5", "6", "7", "8", "9", "-2", "0", "-1"};

    /* renamed from: getView$lambda-0 */
    public static final void m154getView$lambda0(View view) {
    }

    public ConfirmPinButtonAdapter(Context context) {
            ...
            if (str.equals("-2")) {
                ...
                mIvErase.setOnClickListener(new View.OnClickListener() {
                    ...
                    public final void onClick(View view2) {
                        ConfirmPinButtonAdapter.m155getView$lambda1(ConfirmPinButtonAdapter.this, view2);
                    }
                });
            } else {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        ConfirmPinButtonAdapter.m156getView$lambda2(ConfirmPinButtonAdapter.this, str, view2);
                    }
                });
            }
        }
    ...
    public static final void m155getView$lambda1(ConfirmPinButtonAdapter confirmPinButtonAdapter, View view) {
        ((ConfirmPinLockActivity) confirmPinButtonAdapter.context).onDeleteButtonClicked();
    }

    /* renamed from: getView$lambda-2 */
    public static final void m156getView$lambda2(ConfirmPinButtonAdapter confirmPinButtonAdapter, String str, View view) {
        ((ConfirmPinLockActivity) confirmPinButtonAdapter.context).onPinButtonClicked(str);
    }
