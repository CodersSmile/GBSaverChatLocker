...
import com.gbsaver.chatlocker.activity.ForgotPinActivity;
import com.gbsaver.chatlocker.utils.Util;

import java.lang.reflect.Method;
import java.util.Objects;

public final class ForgotPinAdapter extends BaseAdapter implements Util {
    ...
    public ForgotPinAdapter(Context context) {
            ...
            if (str.equals("-2")) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ForgotPinAdapter.m166getView$lambda0(view);
                    }
                });
                ...
                mIvErase.setOnClickListener(new View.OnClickListener() {
                    ...
                    public final void onClick(View view2) {
                        ForgotPinAdapter.m167getView$lambda1(ForgotPinAdapter.this, view2);
                    }
                });
            } else {
//                textView.setLayoutParams(new LinearLayout.LayoutParams(dp2px, dp2px));
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        ForgotPinAdapter.m168getView$lambda2(ForgotPinAdapter.this, str, view2);
                    }
                });
            }
        }
    ...
    public static final void m167getView$lambda1(ForgotPinAdapter pinButtonAdapter, View view) {
        ((ForgotPinActivity) pinButtonAdapter.context).onDeleteButtonClicked();
    }

    /* renamed from: getView$lambda-2 */
    public static final void m168getView$lambda2(ForgotPinAdapter pinButtonAdapter, String str, View view) {
        ((ForgotPinActivity) pinButtonAdapter.context).onPinButtonClicked(str);
    }
